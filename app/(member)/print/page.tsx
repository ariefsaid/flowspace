...
import { printJobs } from "@/lib/mock/print";
...
export default function PrintPage() {
  ...
  const handleSubmit = useCallback(() => {
    // Frontend-only — no real submission
    alert("Print job berhasil dikirim! Tunggu konfirmasi dari petugas.");
  }, []);
      ...
      <Card className="flex items-center gap-3 px-5 py-4">
        ...
        <span className="text-sm text-gray-700">
          ...
          <strong className="text-gray-900">
            {currentMember.printBalance} lembar
          </strong>
        </span>
      </Card>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-6">
          <PrintSummary
            ...
            paperSize={paperSize}
            duplex={duplex}
            printBalance={currentMember.printBalance}
            onSubmit={handleSubmit}
          />

          <PrintHistory jobs={printJobs} />
        </div>
      </div>
    </div>
  );
