...
| [0011](0011-cafe-discount-eligibility-seam.md) | Cafe discount eligibility seam | **Accepted** | On `main` (shipped with I-022). |
| [0012](0012-cafe-order-code-generation.md) | Cafe order-code generation | **Accepted** | On `main` (shipped with I-022). |
...
> **Gaps:** 0005–0009 are absent on `main` (numbers unused).
