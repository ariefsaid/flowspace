...
describe("computeOrderTotals", () => {
  ...
  it("AC-514: discount rounds with Math.round on a fractional-Rupiah subtotal", () => {
    ...
    const frac: PricedLine[] = [
      { menuItemId: "a", nameSnapshot: "A", qty: 1, unitPriceRupiah: 50000, variantOptions: [] },
      { menuItemId: "b", nameSnapshot: "B", qty: 1, unitPriceRupiah: 33334, variantOptions: [] },
      { menuItemId: "c", nameSnapshot: "C", qty: 1, unitPriceRupiah: 16667, variantOptions: [] },
    ]; // subtotal = 100001
